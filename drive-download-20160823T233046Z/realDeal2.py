...
colorFile = open('/home/pi/Desktop/Playlist/gay.txt', 'r')
...
def Degree(theta) :
    ...
    allColors = []
    allColors.append(colorsDecimal[theta1*6:(theta1*6)+6])      #mult by 6 because each hex number = 2 LEDs of color
    allColors.append(colorsDecimal[theta2*6:(theta2*6)+6])
    allColors.append(colorsDecimal[theta3*6:(theta3*6)+6])
    allColors.append(colorsDecimal[theta4*6:(theta4*6)+6])
